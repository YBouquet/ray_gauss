...
def launch_pipeline(pipeline : ox.Pipeline, sbt, gas, colors):
...
if __name__ == "__main__":
    ...
    colors = torch2cupy(torch.ones(6).float().cuda().contiguous())[0]
    img = launch_pipeline(pipeline, sbt, gas, colors)
