...
def build_vertex_generation_kernel(state):
    ...
    #print(ox.module.get_default_nvrtc_compile_flags()) # ('-use_fast_math', '-default-device', '-std=c++11')
    build_flags = ('-use_fast_math', '-std=c++11') + (f'-I{example_include_path}',) #ox.module.get_default_nvrtc_compile_flags() + 
